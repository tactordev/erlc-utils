...
function Editor(
    ...
    return (
        <div className={`min-h-[20vh] overflow-y-hidden w-full gap-2 py-2 px-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 mb-4 ${relevant.length > 0 ? "items-end" : "items-center"} justify-center`}>
            {
